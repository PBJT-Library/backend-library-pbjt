import type { CreateLoanDTO, UpdateLoanDTO, ReturnLoanDTO } from '../../types/database.types';
...
export const LoanService = {
  ...
  async borrowBook(data: CreateLoanDTO) {
    console.log('[DEBUG] borrowBook called with data:', JSON.stringify(data, null, 2));
